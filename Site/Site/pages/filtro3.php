 ...
 <div class="content" align="center"> <br><br><br>
    ...
    <center>
		<table style="border: 3px solid white;">
			<thead align="center">
				<tr>
					<th><a href="filtro1.php">Nome</a></th> <th><a href="filtro2.php">Sobrenome</a></th>
					<th><a href="filtro3-1.php">Aniversario</a></th> <th>EndereÇo</th> <th> Telefone </th> <th> CPF </th> <th><a href="filtro4-1.php">Email</a></th> <th> </th> <th> </th>
				</tr>
			</thead>
			<tbody>
				<?php
					$consulta = mysql_query("SELECT * FROM `tbagenda` ORDER BY `tbagenda`.`Aniversario` ASC");
