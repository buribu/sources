		...
		<table style="border: 3px solid white;">
			<thead align="center">
				<tr>
					...
					<th><a href="filtro3.php">Aniversario</a></th> <th>EndereÇo</th> <th> Telefone </th> <th> CPF </th> <th><a href="filtro4.php">Email</a></th> <th> </th> <th> </th>
				</tr>
			</thead>
			<tbody>
				<?php
					$consulta = mysql_query("SELECT * FROM `tbagenda` ORDER BY `tbagenda`.`email` DESC");
