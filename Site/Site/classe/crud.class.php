	...
	<a href='pages/formulario.php'>Voltar ao Menu</a></center>");
			}else{
				//print "<script>location='index.php';</script>";
	echo "<script>alert ('Dados inseridos com sucesso');location='pages/formulario.php';</script>";
		...
		public function atualizar($camposvalores, $where = NULL)
		{
			...
			if(!$this->upd = mysql_query($this->sql_upd))
			{
				die ("<center>Erro na atualização " . "<br>Linha: " . __LINE__ . "<br>" .mysql_error() . "<br>
					<a href='../pages/VisualizarGeral.php'>Voltar ao Menu</a></center>");
			}else{
				print "<center>Registro Atualizado com Sucesso!<br><a href='../pages/VisualizarGeral.php'>Voltar ao Menu</a></center>";
			}
		}  	
		...
		public function excluir($where = NULL)
		{
		  ...
		  if ($regs > 0){
			if(!$this->del = mysql_query($this->sql_del))
			{
				...
				echo "<center>Registro Excluído com Sucesso!<br><a href='pages/VisualizarGeral.php'>Voltar ao Menu</a></center>";
			}
		  }else{
				echo "<center>Registro Não encontrado!<br><a href='pages/VisualizarGeral.php'>Voltar ao Menu</a></center>";
		  }
		}  	
